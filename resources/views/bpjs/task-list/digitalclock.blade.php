...
<body>
    ...
    <h1 class="h1">Halaman Untuk Get Task List</h1><br>
    <h1 id="clock" class="clock"></h1>
    <br><br>
    <h1 class="h1">Antrian Akan Di Proses Pukul: 22.05 WIB</h1><br>
    ...
    <script>
        ...
        function fetchPeserta() {
            $.ajax({
                url: '{{ route("tasklist.autostore") }}', // Panggil route yang diinginkan
                method: 'GET',
